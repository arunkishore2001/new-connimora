...
<body>
    ...
    <div class="container-fluid-max">
        <div class="contact-bg contact-about-bg">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <div class="contact-heading my-5">
                        <h5 class="comman-sub-heading">[ Contact Us ]</h5>
                        <h3 class="sketch-heading">Get In Touch</h3>
                        <p class="sketch-para">
                    ...
                    <div class="contact-form">
                        <form action="">
                            ...
                            <div class="button-container landing-btn working-btn">
                        ...
                        <div class="contact-details">
                            <div class="contact-heading">
                                ...
                                <p class="contact-para">
                                    ...
                                    is proved in practice by many of our customers. A
