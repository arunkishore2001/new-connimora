...
<head>
    ...
    <title>Our Projects - Successful Farmland Investments by Connemara Realty</title>
    <link rel="icon" href="./images/logo.ico" type="image/x-icon">
    <meta name="description"
        content="Discover our successful farmland projects at Connemara Realty. Explore managed farmland options that offer high returns, sustainability, and family getaway opportunities. See how we make your investment grow.">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="left-landing-image" data-animation="slideInRight">
                        ...
                        <img src="./images/project-left.jpg" alt="Connemara Reality" />
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="right-landing-image" data-animation="slideInLeft">
                        ...
                        <img src="./images/project-work.jpg" alt="Connemara Reality" />
                    </div>
                </div>
            </div>
        </div>
            ...
            if (count($recentImages) > 0) {
                ...
                <div class="container-fluid mb-5">
                    ...
                    <div class="about-page-heading">
                        ...
                        <h2 data-animation="slideInDown" class="m-0" data-animation-delay="200ms">
                            <?php echo $recentProjectName; ?>
                        </h2>
                        ...
                        <div id="gallery">
                            <?php foreach ($recentImages as $key => $recentImage) { ?>
                                <div class="img-responsive">
                                    <img data-animation="zoomIn" loading='lazy' src="<?php echo $recentImage['url']; ?>" alt="Connemara Reality">
                                </div>
                            <?php } ?>
                        </div>
                    </div>
                ...
                <?php while ($video = mysqli_fetch_assoc($videoQuery)): ?>
                    <div class="flex-item" data-animation="slideInDown">
                        ...
                        <a href="https://www.youtube.com/watch?v=<?php echo $video_id; ?>" target="_blank">
                            <img src="https://img.youtube.com/vi/<?php echo $video_id; ?>/hqdefault.jpg" class="img-fluid"
                                alt="Connemara Reality">
                        </a>
                    </div>
                <?php endwhile; ?>
            </div>
        ...
        while ($projectResult = mysqli_fetch_assoc($projectQuery)) {
            ...
            if (count($images) >= 2) {
                ...
                <div class="container-fluid-max ">
                    <div class="project-background" data-animation="slideInRight" data-animation-delay="20ms"></div>

                    <div class="container-fluid project-detail ">
                        <div class="row">
                            <div class="col-md-6" data-animation="slideInRight" data-animation-delay="40ms">
                            ...
                            <div class="col-md-6">
                                <div class="project-img">
                                    <img data-animation="slideInRight" loading='lazy' data-animation-delay="20ms"
                                        src="<?php echo $imageUrl1; ?>" alt="Connemara Reality">
                                    <img data-animation="slideInRight" loading='lazy' data-animation-delay="40ms"
                                        src="<?php echo $imageUrl2; ?>" alt="Connemara Reality">
                                </div>
                            </div>
                        </div>
                    </div>
